package io.github.huahill.vadmin.starter;
...
class StarterDependencyTest {
    ...
    void composesTheSpringAdaptersWithoutDependingOnAnApplicationOrBusinessExample() throws Exception {
        ...
        assertThat(coordinates).containsKeys("vadmin", "vadmin-spring-security", "vadmin-spring-jpa",
                "vadmin-spring-boot", "vadmin-spring-flow", "spring-boot-starter", "vaadin-dev", "postgresql");
