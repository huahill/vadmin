...
public final class OidcLocalUserAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private java.util.Optional<io.github.huahill.vadmin.contracts.auth.LocalUserAccount>
        ...
        try {
            return identityMapper.map(identityFactory.from(oidcUser))
                    ...
                    .filter(io.github.huahill.vadmin.contracts.auth.LocalUserAccount::enabled);
