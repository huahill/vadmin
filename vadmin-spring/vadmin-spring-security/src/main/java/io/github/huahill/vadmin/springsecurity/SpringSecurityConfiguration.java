package io.github.huahill.vadmin.springsecurity;
...
import io.github.huahill.vadmin.contracts.auth.ExternalIdentityMapper;
...
import io.github.huahill.vadmin.springsecurity.auth.AuthenticationVersionFilter;
import io.github.huahill.vadmin.springsecurity.auth.DiscardingOAuth2AuthorizedClientRepository;
import io.github.huahill.vadmin.springsecurity.auth.LocalUserDetailsService;
import io.github.huahill.vadmin.springsecurity.auth.LocalLoginAuthenticator;
import io.github.huahill.vadmin.springsecurity.auth.OidcAccessDeniedFailureHandler;
import io.github.huahill.vadmin.springsecurity.auth.OidcLocalUserAuthenticationSuccessHandler;
import io.github.huahill.vadmin.springsecurity.auth.SecurityContextCurrentUserProvider;
import io.github.huahill.vadmin.springsecurity.auth.SpringAuthorizationService;
import io.github.huahill.vadmin.springsecurity.ui.LoginView;
...
public class SpringSecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, DaoAuthenticationProvider authenticationProvider,
        ...
        http.authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/vadmin/**").permitAll()
