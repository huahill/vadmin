package io.github.huahill.vadmin.springjpa.access;

import io.github.huahill.vadmin.contracts.auth.LocalUserSession;
...
public final class JpaLocalUserSessionLookup implements LocalUserSessionLookup {
    ...
    public Optional<LocalUserSession> findSessionByUserId(UUID userId) {
        return entityManager.createQuery("""
                        select new io.github.huahill.vadmin.contracts.auth.LocalUserSession(
