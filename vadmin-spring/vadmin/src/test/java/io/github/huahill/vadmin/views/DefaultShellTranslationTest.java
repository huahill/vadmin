...
class DefaultShellTranslationTest {
    ...
    void resolvesModuleMetadataThroughTranslationsInsteadOfAHostSpecificLabelMap() throws Exception {
        var source = Files.readString(Path.of("src/main/java/io/github/huahill/vadmin/views/DefaultMainLayout.java"));
        var home = Files.readString(Path.of("src/main/java/io/github/huahill/vadmin/views/DefaultHomeView.java"));
        ...
        assertThat(source).contains("new Avatar(user.username())")
                ...
                .contains("margin-inline-start", "var(--vaadin-padding-m)")
                .contains("margin-inline-end", "var(--vaadin-padding-m)")
