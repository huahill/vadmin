...
import io.github.huahill.vadmin.contracts.audit.AuditEvent;
import io.github.huahill.vadmin.contracts.audit.AuditOutcome;
...
import io.github.huahill.vadmin.app.auth.ConfiguredExternalIdentityMapper;
import io.github.huahill.vadmin.app.auth.OidcIdentityLinkProperties;
import io.github.huahill.vadmin.platform.access.AccessControlRepository;
import io.github.huahill.vadmin.platform.access.GrantPermissionService;
...
public class ApplicationConfiguration {
    @Bean
    @ConditionalOnProperty(prefix = "vadmin.identity.oidc.links[0]", name = "issuer")
    ...
    private String bootstrapPassword(Environment environment) {
        ...
        var password = development ? environment.getProperty("vadmin.bootstrap.password", "change-me")
