package io.github.huahill.vadmin.app.oidc;
...
class KeycloakOidcIT {
    ...
    static void oidcProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("vadmin.identity.oidc.links[0].issuer", keycloak::issuerUri);
        registry.add("vadmin.identity.oidc.links[0].subject", () -> "10000000-0000-0000-0000-000000000001");
        registry.add("vadmin.identity.oidc.links[0].username", () -> "admin");
    }
