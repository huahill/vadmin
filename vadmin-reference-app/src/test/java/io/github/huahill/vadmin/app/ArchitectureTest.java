...
@AnalyzeClasses(packages = "io.github.huahill.vadmin")
class ArchitectureTest {
    ...
    static final ArchRule reference_app_does_not_own_default_shell_or_system_administration = noClasses()
            .that().resideInAnyPackage("io.github.huahill.vadmin.app..")
    ...
    static final ArchRule only_the_default_administration_and_flow_adapter_depend_on_springflow = noClasses()
            .that().resideOutsideOfPackages("..app..", "..springflow..",
                    ...
                    "io.github.huahill.vadmin.administration..",
                    "io.github.huahill.vadmin.brand..",
                    "io.github.huahill.vadmin.localiam..",
                    "io.github.huahill.vadmin.modules..",
                    "io.github.huahill.vadmin.shell..",
                    "io.github.huahill.vadmin.theme..",
                    "io.github.huahill.vadmin.views..")
